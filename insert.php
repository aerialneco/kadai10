...
$stmt = $pdo->prepare("INSERT INTO counselor_table(
  id, organization, name, kana, certification, email, tel, website, address, details, date_time, file_name, file_path
) VALUES (
  NULL, :organization, :name, :kana, :certification, :email, :tel, :website, :address, :details, sysdate(), :filename, :save_path
)");
